        ...
        methods: {
            startStreaming: function(lastResponseLength, productFeedUrl){
                ...
                xhr.onprogress = function(e) {
                    ...
                    if (output.includes("{")) {
                        let jsonProduct = jsonHelper.createJsonObject(output)
                        ...
                        let jsonCategories = jsonProduct.categories
                        let categories = ''
                        let categoriesArray = Object.keys(jsonCategories).map(function (k) {
